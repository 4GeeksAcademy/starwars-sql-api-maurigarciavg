...
def setup_admin(app):
    ...
    admin = Admin(app, name='4Geeks Admin', template_mode='bootstrap3') // ✅ Inicialización correcta de Flask-Admin
    
    # Add your models here, for example this is how we add a the User model to the admin
    admin.add_view(ModelView(User, db.session)) // ✅ Agregando el modelo User correctamente

    # You can duplicate that line to add mew models // 🔧 Corrección: 'mew' debe ser 'new'
